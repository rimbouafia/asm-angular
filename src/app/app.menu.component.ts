    ...
    ngOnInit() {
        this.model = [
            ...
            },
            {
                label: 'UI Components',
                items: [
                    {label: 'Inscription', icon: 'pi pi-fw pi-check-square', routerLink: ['/uikit/Inscription']},
                    {label: 'ListeInscription', icon: 'pi pi-fw pi-check-square', routerLink: ['/uikit/ListeInscription']},
