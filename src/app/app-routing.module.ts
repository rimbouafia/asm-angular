...
import { ListeInscriptionComponent } from './components/inscription/liste-inscription/liste-inscription.component';
@NgModule({
    imports: [
        RouterModule.forRoot([
            {
                ...
                children: [
                    {path: 'uikit/Inscription', component: InscriptionComponent},
                    {path: 'uikit/ListeInscription', component: ListeInscriptionComponent},
